...
<%@ page import="com.hm.oa.global.Constants" %>
<%--
            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <form:form id="admin-form" name="addForm"
                               action="${pageContext.request.contextPath}/claim_voucher/check" method="post"
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                <c:if test="${sessionScope.session_user.post == Constants.POST_FM
                                ||sessionScope.session_user.post == Constants.POST_GM }">
                                    <button type="submit" class="button" name="dealWay"
                                            value="${Constants.DEAIL_PASS}">${Constants.DEAIL_PASS}</button>
                                    <button type="submit" class="button" name="dealWay"
                                            value="${Constants.DEAIL_BACK}">${Constants.DEAIL_BACK}</button>
                                    <button type="submit" class="button" name="dealWay"
                                            value="${Constants.DEAIL_REJECT}">${Constants.DEAIL_REJECT}</button>
                                </c:if>
                                <c:if test="${sessionScope.session_user.post == Constants.POST_CASHIER}">
                                    <button type="submit" class="button" name="dealWay"
                                            value="${Constants.DEAIL_PAID}">${Constants.DEAIL_PAID}</button>
                                </c:if>
