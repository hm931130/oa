                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="section row">
                                <div class="col-md-6">
                                    <label for="sn" class="field prepend-icon">
                                        <fort:input path="sn" cssClass="gui-input" readonly="true" placeholder="编号..."/>
                                ...
                                <div class="col-md-6">
                                    <label for="name" class="field prepend-icon">
                                        <fort:input path="name" cssClass="gui-input" placeholder="名称..."/>
                            ...
                            <div class="section">
                                <label for="address" class="field prepend-icon">
                                    <fort:input path="address" cssClass="gui-input" placeholder="地址..."/>
